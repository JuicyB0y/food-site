...
const Nav = () => {
  ...
  return (
    <nav className='сюда добавить класс'>
        ...
        {arr.map(({ name }, index) => {
          return (
            <li
              ...
              className={`promo__nav-item ${
                active === index ? 'promo__nav-active' : ''
              }`}
              key={name}
            >
              <span className='promo__nav-link'>{name}</span>
            </li>
          );
        })}
        <li className='promo__nav-item promo__nav-point'>
          <a className='promo__nav-link' href='#'>
            Sign in
          </a>
        </li>
        <li className='promo__nav-item promo__nav-wide'>
          <a className='promo__nav-link promo__nav-started' href='#'>
            Get Started
          </a>
        </li>
      </ul>
  ...
  const arr = [
    {
      ...
      img: cup,
    } /* Как правильно прописывать картинку */,
    {
      title: 'Eam commodo',
  ...
  return (
    <section className='ability'>
      <div className='ability__title'>
        <span className='ability__span'>
          Promoting your business and services with Propel:
        </span>
        <br />A responsive, multi-page business template with everything you
        need propel your business.
      </div>
      <div className='ability__cards'>
        {arr.map(({ title, text, img }) => {
          return (
...
const Pic = () => {
  return (
    <section className='pic'>
      ...
      <p className='pic__text'>
        <span className='pic__subtitle'>Illud decore voluptaria has at.</span>{' '}
        <br />
    ...
    <section className='menu'>
      <div className='menu__wrapper'>
        ...
        <div className='menu__descr'>
          <div className='menu__descr-subtitle'>
            <span className='menu__descr-span'>
              Ex tempor euismod sapientem ouis lexor pro.
            </span>{' '}
            Ad vix dicta iudico singulis, ius ex mollis veritus.
          </div>
          <div className='menu__descr-text'>
  ...
  return (
    <section className='info'>
      <div className='info__descr'>
        ...
        <div className='info__descr-text'>
          <span className='info__descr-span'>Quas suscipit ad mea.</span> Pri cu
          dico labores officiis odio principes complectitur ad sea.
        </div>
      </div>
    ...
    <footer className='footer'>
      ...
      <div className='footer__right'>
        ...
        <div className='footer__social'>
          <a className='footer__social-icons' href='#'>
