          ...
          бэкграунд?) */}
            <nav>
              ...
              <li className='promo__nav-item'>
                ...
                <li className='promo__nav-item'>
                  <a className='promo__nav-link' href='#'>Features</a>{' '}
                </li>
                <li className='promo__nav-item'>
                  <a className='promo__nav-link' href='#'>Premium</a>
                </li>
                <li className='promo__nav-item'>
                  <a className='promo__nav-link' href='#'>Pricing</a>
                </li>
                <li className='promo__nav-item'>
                  <a className='promo__nav-link' href='#'>About</a>
                </li>
